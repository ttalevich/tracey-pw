...
<div id="container">
    <div id="content">
        <div class="banner">
            ...
            <div class="holder"><img src="<?php echo get_bloginfo('template_directory');?>/images/thumb/banner-sub-1.png" alt="Groupo Floresta - Building a Better Community"></div>
            <div class="holder"><img src="<?php echo get_bloginfo('template_directory');?>/images/thumb/banner-sub-2.png" alt="Ivory - Mens Designer Clothing Consignment">
            </div>
        </div>
        ...
        <div class="banner">
            ...
            <div class="holder"><img src="<?php echo get_bloginfo('template_directory');?>/images/thumb/banner-sub-3.png" alt="Cooper Lanza Art - Bellingham, WA Oil Paint Artist Portfolio Page"></div>
            <div class="holder"><img src="<?php echo get_bloginfo('template_directory');?>/images/thumb/banner-sub-4.png" alt="West Side Music Academy - Seattle Music School">
            </div>
        </div>
